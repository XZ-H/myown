<template>
  <div class="column" id="middle-chart">
    <div class="no">
      <div class="no-hd">
        <ul>
          <li>47.22%</li>
...
export default {
  ...
  methods: {
    darwMidMap: function () {
      ...
      this.axios
        .all([
          this.axios.get("static/data/hubei.json"),
          this.axios.get("static/data/hb_GDP.json"),
        ])
        .then(
          this.axios.spread(function (userResp, reposeResp) {
